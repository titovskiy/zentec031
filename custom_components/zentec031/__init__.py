...
def _build_runtime_config(entry: ConfigEntry) -> dict[str, int | bool]:
    ...
    return {
        ...
        CONF_POWER_COIL: int(options.get(CONF_POWER_COIL, data.get(CONF_POWER_COIL, DEFAULT_POWER_COIL))),
        CONF_POWER_REGISTER: int(
            options.get(CONF_POWER_REGISTER, data.get(CONF_POWER_REGISTER, data.get(CONF_POWER_COIL, DEFAULT_POWER_REGISTER)))
        ),
